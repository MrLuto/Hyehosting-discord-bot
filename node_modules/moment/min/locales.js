   ...
   factory(global.moment)
    ...
    moment.defineLocale('fy', {
        ...
        relativeTime : {
            ...
            d : 'ien dei',
            dd : '%d dagen',
            M :hortDot = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_'),
    ...
    var monthsParse$5 = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/em %s',
            past : 'há %s',
            s : 'segundos',
            ss : '%d segundos',
            m : 'um minuto',
    ...
    moment.defineLocale('si', {
        ...
        weekdaysShort : 'ඉරි_සඳු_අඟ_බ�i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i];
    ...
    moment.defineLocale('pt', {
        ...
        relativeTime : {
            future : '�ා_බ්‍රහ_සිකු_සෙන'.split('_'),
